...
<br>
<label>Additional principal paid: $
  <input type="text" id="past-prepayment-monthly-input" class="absolute" inputmode="decimal">/mo
</label>
or $
<input type="text" id="past-prepayment-total-input" class="absolute" inputmode="decimal"> total
<span id='past-prepayment-hint'></span>
<br>
